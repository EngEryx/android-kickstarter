...
public class AssignmentFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        assignmentViewModel.getAllAssignmentsOnline();
        ...
        assignmentViewModel.assignments.observe(this, new Observer<List<Assignment>>() {
            @Override
            public void onChanged(@Nullable List<Assignment> assignments) {
                if (assignments!=null){


                    assignmentAdapter.updateData(assignments);
                }
            }
        });
